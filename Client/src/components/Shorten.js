...
import { getList, shortUrl, shortdirect, URL } from './UserFunctions'
...
class Shorten extends Component {
  ...
  getAll = () => {
    getList(localStorage.usertoken)
      .then((data) => {
        this.setState(
          {
            items: [...data],
  ...
  render() {
    return (
      <div style={{ backgroundColor: ' #2D3D5A', height: '100vh' }}>
        <div style={{ backgroundColor: ' #2D3D5A', height: '100%' }}>
          <div
            style={{
          ...
          >
            <div className="urlheader">Shortening URL</div>
            <div className="urlheader">Shortening URL</div>
            <div
              className="heading"
            ...
            {this.state.errorOccur && (
              <div style={{ color: 'blue', margin: '5px' }}>
                {this.state.error}
              </div>
            )}
          </div>
          ...
          <div className="outerdiv">
            <div class="table-responsive">
              <table
                className="table"
                style={{ backgroundColor: ' #051438', padding: '20px' }}
              >
                <tbody>
